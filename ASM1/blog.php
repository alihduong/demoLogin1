            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="oneMusicNav">
                        ...
                        <!-- Nav brand -->
                        <a href="index.html" class="nav-brand">Tune Source</a>
                            ...
                            <div class="classynav">
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    <form action="search.php">
                                        <input type="text" name="txtUser" class="form-control" placeholder="Search" required>
                                        <input type="submit" class="classynav">
                                    </form>
                                </div>
                                    <!-- Cart Button -->
                                    <div class="cart-btn login-register-cart-button d-flex align-items-center">
